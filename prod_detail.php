    ...
    <div class="row">
      <div class="col-sm-2">
        <h4>Filter <span style="float: right;"><button type="button"
              class="btn btn-outline-primary">Reset</button></span></h4>
        ...
        <?php
            ...
            if(isset($_POST['prodetail']))
            {
                ...
                foreach($query_run as $row)
                {
                    ...
                    <?php echo '<img src="product_img/'.$row['image1'].'" style="width: 230px; height: 350px;""  alt="image">'?>
                    <?php echo '<img src="product_img/'.$row['image2'].'" style="width: 230px; height: 350px;""  alt="image">'?>
