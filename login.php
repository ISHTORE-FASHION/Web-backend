...
<body>
  ...
  <div class="container-fluid login" style="background-image: linear-gradient(to right, #b9b4f3 , #fadae7); min-height: 40.8rem;margin-top: 100px;">
    <div class="row">
      <div class="box">
      <?php
        ...
        <div class="d-grid gap-2">
          <button class="btn login-btn" name="login_btn" type="submit">CONTINUE</button>
        </div>
        <p class="help mt-3">Have trouble logging in? <span id="hideLogin"> Get Help</span></p>
        <img style="width: 50%; margin-left: 176px; margin-top: 50px;" src="log.png" alt="">
      </div>
          </form>
    </div>
  </div>

  <div class="container-fluid gethelp" style="background-image: linear-gradient(to right, #b9b4f3 , #fadae7); min-height: 40.8rem;margin-top: 100px;">
    <div class="row">
      <div class="box">
