                    ...
                    <div class="container" style="margin-top: 2rem;">
                      <div class="row">
                        ...
                        <p style="font-size:0.9rem; text-align: center;margin: 0; margin-bottom: 0.5rem;"><a
                          style="text-decoration: none; color: #a1a0f8!important;font-size: 1rem;" href="loginmodal.php">Login</a> <span
                            ...
                            <div class="d-flex flex-row " style="align-items: center; justify-content: center;">
                             ...
                             <div id="myModal1" class="modal1">
                              ...
                              data-bs-target="#Modal8" >
                                <i class="far fa-heart mobileicons" aria-hidden="true"></i>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <div class="container">
                                          ...
                                          <div class='modtext' style="justify-content: space-between;">
                                            <h3>1299</h3>
                                            <a class='btn btn-sm'>Check Out</a>
                                          </div>
