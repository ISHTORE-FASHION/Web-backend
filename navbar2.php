    ...
    <section class="navbar-section">
        <div class="main-navbar">
            <nav class="navbar navbar-expand-md navbar-light">
                <a href="index.php" class="navbar-brand myBtn2" role='button'><img style='margin-left: 1rem;width: 20px;'src='./bar.png'></a>
                      ...
                      <div class="row">
                        ...
                        <div class="col-12" style="padding-left: 1rem;font-family:'Roboto', sans-serif; ">
                          <ul style='list-style:initial;'>
                            <li style="margin-bottom: 0.5rem;"><a style="text-decoration: none; color: black;font-size: 0.8rem;" href="profile.php">MEN</a></li>
                              ...
                              <div class="modal-content1" >
                                ...
                                <div class="container">
                                  <div class="row">
                                    ...
                                    <div class="col-9">
                                      <ul style='list-style:initial;'>
                                        <li><a style="text-decoration: none; color: black; font-size: 0.9rem;" href="profile.php">Profile</a></li>
